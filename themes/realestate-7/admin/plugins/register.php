...
function ct_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> __('Contempo Real Estate 7 Extensions Loader', 'contempo'), // The plugin name
			'slug'     				=> 'ct-real-estate-7-extensions-loader', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory_uri() . '/admin/plugins/ct-real-estate-7-extensions-loader.zip', // The plugin source
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/admin/plugins/ct-real-estate-7-payment-gateways.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '1.0.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/admin/plugins/ct-compare-listings.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '1.0.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/admin/plugins/contempo-saved-searches-email-alerts.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/admin/plugins/ct-child-theme.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/admin/plugins/revslider.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			'name'     				=> __('Visual Composer', 'contempo'), // The plugin name
			'slug'     				=> 'js_composer', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory_uri() . '/admin/plugins/js_composer.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			'name' 		=> __('CT Mortgage Calculator', 'contempo'),
			'slug' 		=> 'ct-mortgage-calculator',
			'required' 	=> true,
		),
