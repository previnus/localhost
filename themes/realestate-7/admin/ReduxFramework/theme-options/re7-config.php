<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Upload a @2x logo for high resolution displays recommend using a png, <a href="http://line25.com/tutorials/how-to-create-retina-graphics-for-your-web-designs">More Information on Creating @2x Images</a>',
                'id' => 'ct_logo_highres',
                'type' => 'media',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Select whether or not you\'d like to enable brokerage reviews. NOTE: This requires the "Comments Ratings" plugin, please refer to the <a href="http://contempothemes.com/wp-real-estate-7/documentation/#reviews">documentation</a>.',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array (
                'desc' => 'As of June 22, 2016 Google Maps is now requiring all new sites to use an API Key, which you can get for free <a href="https://developers.google.com/maps/documentation/javascript/">here</a> > click "Get Key" in the upper right (<a href="https://cl.ly/3L0a141I1k0W">screenshot</a>). All existing sites are grandfathered in however it is still recommended.',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Select whether you\'d like to use Community, Neighborhood, Suburb, District, School District or Building.',
                ...
                'title' => 'Community, Neighborhood, Suburb, District, School District or Building?',
                'default' => 'community',
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Select whether or not you\'d like to enable listing reviews. NOTE: This requires the "Comments Ratings" plugin, please refer to the <a href="http://contempothemes.com/wp-real-estate-7/documentation/#reviews">documentation</a>.',
            ...
            array (
                'desc' => 'Select whether or not you\'d like to use a custom form for the single listing contact utilizing the <a href="https://wordpress.org/plugins/contact-form-7/">Contact Form 7</a> plugin, <strong>very important</strong> please be sure to read the <a href="http://contempothemes.com/wp-real-estate-7/documentation/#singlecontactform7">documentation</a> on how to build the form properly includes sample form code.',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array (
                'id' => 'places-app-info',
                'type' => 'info',
                'raw' => '<strong>Note:</strong> In order to set up access to the Google Places API, you need to create an API key which can be entered via the Google Maps options panel.',
                'required' => array('ct_enable_front_end_paid','equals','yes'),
            ),
            array (
                'desc' => 'Select whether or not you\'d like to enable Google Places "What\'s Nearby" Information for listings.',
                ...
                'title' => 'Enable Google Places "What\'s Nearby?" for Listings?',
                'default' => 'no',
                'required' => array('ct_yelp_app_key','!=','')
            ),
            array (
                'desc' => 'Drag and drop manager, to quickly organize the nearby amenities you\'d like to display.',
                'id' => 'ct_yelp_amenities',
                'type' => 'sorter',
                'title' => 'Nearby Places Manager',
            ...
            array (
                'desc' => 'Enter the radius you\'d like to return results for.',
                'id' => 'ct_google_places_radius',
                'type' => 'text',
            ...
            array (
                'desc' => 'Select whether you\'d like for places to link to their respective individual Google Place page.',
                'id' => 'ct_google_places_individual_link',
                'type' => 'select',
                'options' => array (
                    'yes' => 'Yes',
                    'no' => 'No',
                ),
                'title' => 'Link to individual Google Places page?',
                'default' => 'yes',
            ),
            array (
                ...
                'default' => '_self',
                'required' => array('ct_google_places_individual_link','equals','yes'),
            ),
            /*array (
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Select the role you\'d like for users registering from the front end of the site. More on WordPress User Roles &amp; Capabilities can be found at <a href="https://codex.wordpress.org/Roles_and_Capabilities">https://codex.wordpress.org/Roles_and_Capabilities</a>.',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'id' => 'paid-submission-info',
                'type' => 'info',
                'raw' => 'If you\'ve enabled Paid Submissions that requires entering your PayPal API information into the "PayPal Settings" sub menu item on the left.',
                'required' => array('ct_enable_front_end_paid','equals','yes'),
            ),
            array (
            ...
            array (
                ...
                'type' => 'info',
                'raw' => 'Set the pages below for the front end submission system, the Login/Register modal is automatic if the front end login is enabled.',
            ),
            array (
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array (
                'id' => 'paypal-api-info',
                'type' => 'info',
                'raw' => 'In order to use the PayPal API you\'ll first need to signup for free at <a href="https://developer.paypal.com/">https://developer.paypal.com/</a>.',
            ),
            array (
                //'desc' => 'Select whether or not you\'d like to enable users to pay for submissions.',
                'id' => 'ct_enable_paypal',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array (
                'id' => 'stripe-api-info',
                'type' => 'info',
                'raw' => 'In order to use the Stripe API you\'ll first need to signup for free at <a href="https://dashboard.stripe.com/account/apikeys">https://dashboard.stripe.com/account/apikeys</a>.',
            ),
            array (
                //'desc' => 'Select whether or not you\'d like to enable users to pay for submissions.',
                'id' => 'ct_enable_stripe',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'title'  => esc_html__( 'Demo Importer', 'contempo' ),
        'desc'   => __( 'Works best to import on a new install of WordPress. Recommend using the <a href="https://wordpress.org/plugins/wordpress-reset/" target="_blank">WordPress Reset plugin</a> before switching between demos. ', 'contempo' ),
        ...
        'fields' => array(
            ...
            array (
                'id' => 'demo-importer-info',
                'type' => 'info',
                'raw' => '<strong>IMPORTANT:</strong> If the progress bar hangs or the demo fails to import, don\'t fear the worst its a simple fix please see this <a href="https://contempo.ticksy.com/article/5952/">KB article</a>. The demos include A LOT of images so some servers will timeout when trying to download all of them and the servers max_execution_time just needs to be raised via your php.ini file, your hosting provider can help you out with this. I\'ve also included manual import steps for those who have hosting that will not allow you to modify your php.ini (usually the cheap hosts), see some of the hosting providers I recommend below.',
            ),
            array (
                'id' => 'demo-importer-hosting',
                'type' => 'info',
                'raw' => '
