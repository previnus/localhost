	    ...
	    foreach ($ct_single_listing_content_layout as $key => $value) {
	        ...
	        switch($key) {
    	        ...
    	        case 'listing_content' :
    	            ...
    	            echo '<!-- Content -->';
									echo '<div id="hg-content">';
									the_content();
									echo '</div><button type="button" class="hgBtnStyling hg-show-more hgcommentbtn">Lire plus</button>';
									echo '<button type="button" class="hgBtnStyling hg-show-less hgcommentbtn">Réduire</button>';
