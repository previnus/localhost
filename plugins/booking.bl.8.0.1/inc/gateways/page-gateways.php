...
function wpbc_get_default_options_gw() {
    ...
    $default_options[ 'booking_gateways_order' ] = 'paypal,authorizenet,sage,bank_transfer,pay_cash,ipay88';    // ,ideal
...
function wpbc_load_payment_gateways_files() {
    ...
    $booking_gateways_original = 'paypal,authorizenet,sage,bank_transfer,pay_cash,ipay88';   //,ideal     // Default Original Payment Gateways
