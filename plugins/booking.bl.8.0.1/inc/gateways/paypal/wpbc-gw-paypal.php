...
//debuge( '$params', $params ); return '';
	...
	if(0)
        ...
        if ( $payment_options[ 'button_type' ] == 'custom' ) {
            ?><input type="submit" class="btn btn-success" id="gtmpaid" name="submit"  value="<?php echo $payment_options[ 'payment_button_title' ]; ?>" /><?php 
        } else {
        ...
        ?></form>
        <div class="alert alert-warning" role="alert"><p><span class="glyphicon glyphicon-exclamation-sign"></span> 
        Une fois le paiement effectué, vous recevrez très rapidement un email de confirmation de notre part : le cas échéant, pensez bien à vérifier dans vos courriers indésirables.</p></div></div><?php 
