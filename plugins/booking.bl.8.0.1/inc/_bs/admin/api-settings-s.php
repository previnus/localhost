...
function wpbc_settings_calendar_check_in_out_times__bs( $fields, $default_options_values ) { 
    ...
    $fields['booking_change_over_days_triangles'] = array(   
                            ...
                            , 'description' => sprintf( 'Its require showing calendar days cells as square (not rectangle). Width and height of calendar you can define in %sshortcode options parameter%s.%sSupported by: Chrome 36.0+, MS IE 10.0+, Firefox 16.0+, Safari 9.0+, Opera 23.0+' 
														,'<a href="http://wpbookingcalendar.com/help/booking-calendar-shortcodes/#booking-options" target="_blank">','</a>', '<br/>')
                            , 'group'       => 'calendar'
                            , 'tr_class'    => 'wpbc_recurrent_check_in_out_time_slots wpbc_check_in_out_time_slots wpbc_sub_settings_grayed'
        );            
