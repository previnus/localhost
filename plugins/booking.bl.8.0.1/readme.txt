...
- Changes in **all** versions:
    ...
    * **Fix** Force to load jquery-migrate in case, if we do  not know Thank you. version  of jQuery which  was loaded. (8.0.1.2)
- Changes in **Personal / Business Small / Business Medium / Business Large / MultiUser** versions:
    * **Fix** Showing correctly  change-over days (tringles),  when  inserted only "availability calendar", without booking form (8.0.1.2) *(Business Small/Medium/Large, MultiUser)*
    * **Fix** correctly showing single and double quotes (' and ") symbols during bookings editing in textareas (8.0.1.3) *(Personal Business Small/Medium/Large, MultiUser)*
    * **Fix** Issue of not saving chnages during editing, if you try to search some booking resource (or other item), and this booking resource was not at the 1st  page (during usual listing)  (8.0.1.12) *(Personal Business Small/Medium/Large, MultiUser)*
    * **New** Something... *(Personal Business Small/Medium/Large, MultiUser)*
