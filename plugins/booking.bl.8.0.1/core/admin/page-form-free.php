...
//$my_form =  '<div style="float:left;margin-right:35px;" >[calendar]</div><div style="float:left;margin-top:-20px;" >';	//FixIn: 8.0.1.5 	//Fix: Form2collumns
...
//$my_form .= '  </div><div style="clear:both;"></div>' ;																	//FixIn: 8.0.1.5 	//Fix: Form2collumns
