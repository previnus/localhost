...
// S U P P O R T       F u n c t i o n s    //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function wpbc_enqueue_js_files( $where_to_load = 'both' ){ 
        wp_enqueue_script( 'wpbc-bm',         WPBC_PLUGIN_URL . '/inc/js/biz_m'.((WP_BK_MIN)?'.min':'').'.js', array( 'wpbc-global-vars' ), '1.0');
        wp_enqueue_script( 'wpbc-conditions', WPBC_PLUGIN_URL . '/inc/js/form-conditions'.((WP_BK_MIN)?'.min':'').'.js', array( 'wpbc-bm' ), '1.0');
    }
...
//debuge(gettype($field__values), $booking_form_name);
        $full_procents = 1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function fixed_deposit_amount_apply($summ , $post_form, $booking_type , $booking_days = false ) {
        ...
        // if ($is_resource_deposit_payment_active == 'On') {
                ...
                else $fixed_deposit = array('amount'=>'50',
                                            'type'=>'%',
                                            'active' => 'On',
                                            'apply_after_days' => '60',
                                            'season_filter' => '0'
